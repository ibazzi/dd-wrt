...
<li>the first free and {j}http://wiki.milkfish.org/index.php?n=MilkfishServices.Homesip" target="new">user specific alphanumeric dialing</a> infrastructure - choose <b>yourname.homesip.net</b></li>
<li>improved NAT traversal by means of a combined SIP-RTP-proxy - equipped with a selective STUNBLOCKER</li>
<li>support for LAN-connected PBX-Adapter hardwares - find an example {j}http://wiki.milkfish.org/index.php?n=TheMilkfish.FritzBox" target="new">here</a></li>
...
<li>direct dialling through the {j}http://www.sipbroker.com" target="new">SIPBroker</a> Network Directory using <b>*1</b> as a prefix before the SIPBroker <i>SIP-Code</i></li>
<li>SIP/SIMPLE messaging via web interface</li>
<li>Find more feature descriptions {j}http://www.milkfish.org/?page_id=7" target="new">here</a> or {j}http://wiki.milkfish.org/index.php?n=Milkfish-dd.Features" target="new">there</a>...</li>
-->				<!--/ul><br />
{e}"note">
<h4>Get support...</h4>
<div><br />
Find the documentation of this embedded software at {j}http://wiki.milkfish.org" target="new">wiki.milkfish.org</a>.<br>
Any questions can go to the user forum being available at {j}http://forum.milkfish.org" target="new">forum.milkfish.org</a>.</div>
</div><br />
{e}"note">
<h4>Give support...</h4>
<div><br />
...
{e}"note">
					{e}"center">Milkfish is developed by...<br><a target="_blank" href="http://www.sipwerk.com"><img border="1" src="../images/sipwerk.png" alt="sipwerk logo" /></a><br></div><br />
</div><br />
</dd>

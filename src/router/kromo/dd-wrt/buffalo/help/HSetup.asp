...
{e}"note">
<h4>Note</h4>
<div>After you have configured these settings, you should set a new password for the router using the {j}HManagement.asp">Management</a> screen. This will increase security, protecting the router from unauthorized changes. All users who try to access the router web-based utility or Setup Wizard will be prompted for the router's password.</div>
</div>
</dd-->
<% tran("hidx.page1"); %>
...
{e}"note">
<h4>Note</h4>
<div>Some cable providers require a specific MAC address for connection to the Internet. To learn more about this, click the System tab. Then click the Help button, and read about the {j}HWanMAC.asp">MAC Address Cloning</a> feature.</div>
</div>
</dd-->
<% tran("hidx.page4"); %>

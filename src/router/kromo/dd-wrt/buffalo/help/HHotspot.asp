...
<dt>{m}Capture(hotspotsys.legend)</script></dt>
...
For more information please visit {j}http://www.hotspotsystem.com">www.hotspotsystem.com</a></dd-->
<% tran("hstatus_hots.page2"); %>
<dt>{m}Capture(hotspotsys.operatorid)</script></dt>
<!--dd>The Operator Username which you have registered at {j}http://www.hotspotsystem.com">www.hotspotsystem.com</a></dd-->
<% tran("hstatus_hots.page3"); %>
<dt>{m}Capture(hotspotsys.locationid)</script></dt>
<!--dd>The number of the location you would like to set up.</dd-->
<% tran("hstatus_hots.page4"); %>
<dt>{m}Capture(hotspotsys.nobridge)</script></dt>
...
<dt>{m}Capture(hotspot.pserver)</script></dt>
<!--dd>The IP addresses of radius server 1 and 2.</dd-->
<% tran("hstatus_hots.page9"); %>
<dt>{m}Capture(hotspot.dns)</script></dt>
...
<dt>{m}Capture(hotspot.uamdns)</script></dt>
...
<dt>{m}Capture(hotspot.allowuam)</script></dt>
...
<dt>{m}Capture(hotspot.macauth)</script></dt>
...
<dt>{m}Capture(hotspot.option)</script></dt>
<!--dd>You can specify here additional Options.<br><br>
{e}"note">
<h4>Note</h4>
<div>For more informations about the different options : {j}http://www.chillispot.info/chilli.html">www.chillispot.info</a>.</div>
</div>
</dd-->

...
<dd>DHCPd assigns IP addresses to your local devices. While the main configuration is on the setup page you can program some special functions here.
<ul class="wide">
...
{e}"note">
<h4>Note</h4>
<div>All options are saved in /tmp/dnsmasq.conf file. The format of this file consists of one option per line.<br/>The complete list of available options : {j}http://thekelleys.org.uk/dnsmasq/docs/dnsmasq-man.html" target="_new">DNSMasq man</a>.</div>
</div>
</dd>

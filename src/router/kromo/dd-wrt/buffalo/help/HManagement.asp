...
You can also enable <em>SSH</em>&nbsp; to remotely access the router by Secure Shell. Note that SSH daemon needs to be enable in {j}HServices.asp"-->
<% tran("hmanagement.page3"); %>
<% tran("bmenu.servicesServices"); %><!--/a> page.<br /><br />
{e}"note">
<h4>Note</h4>

...
<ol class="wide">
<li>Make sure you are using the same {j}HWireless.asp">Wireless Settings</a> on both routers and not any type of {j}HWPA.asp">Wireless Security</a>.</li>
...
<li>Go to the {j}HStatusWireless.asp">Wireless Status</a> page. You should see <i>WDS Link</i> and the Wireless MAC of the other router listed, with a signal reading. If the signal is "0dBm" then there may be something wrong. Check your antenna connections and configuration settings, and try again.</li>
<li>Once you have a good signal (-70dBm to -30dBm, -70dBm being lowest), you can change the <i>Internet Connection Type</i> on the {j}HSetup.asp">Basic Setup</a> page of the second router to <i>Disabled</i> and set the <em>Gateway</em> to the LAN IP Address of the first router. You can now run normal tests to check if you are connected (like <tt>ping</tt>).</li>
</ol><br /><br />
{e}"note">
<h4>Note</h4>
...
<ul>
<li>{j}HWireless.asp">Wireless Settings</a></li>
<li>{j}HWPA.asp">Wireless Security</a></li>

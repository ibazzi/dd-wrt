...
<dd><br/>
<ul>
<li>Path: Path to mounted partition. See currently mounted disks under {j}../USB.asp">Disk Info</a> </li>
...
You want to share <i>D:\public</i>. To do this connect the usb drive and lookup or specify a mountpoint under {j}../USB.asp">USB Settings</a>.</br>

...
<li>{j}Hradauth.asp">Radius Authentification</a></li>
<li>{j}HWirelessMAC.asp">Wireless MAC Filter</a></li>
<li>{j}HWirelessAdvanced.asp">Advanced Wireless Settings</a></li>
</ul>
</div>
</body>
</html>
